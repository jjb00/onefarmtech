...
export async function protectPublicIntake(input: {formType: "contact" | "order-request" | "career" | "supplier" | "group-buy-request"; action: string; token?: string; honeypot?: string; values: unknown[]; fetcher?: typeof fetch}) {
