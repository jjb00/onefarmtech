...
import { mockCustomers, badgeClass } from "@/data/mockAdmin";
      ...
      <section className="mx-auto max-w-7xl">
        ...
        <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-[#d8e8dc]">
              Manage buyer records, business profiles, payment terms, credit limits, and verification status.
            </p>
          </div>
        ...
        <section className="mt-10 rounded-[2rem] bg-white p-6 text-[#102015] shadow-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              <h2 className="text-2xl font-bold">Customers table</h2>
