    ...
    >
      <div className="grid gap-6">
        {params?.success && successMessages[params.success] ? (
          <div role="status" className="rounded-2xl border border-[#1f7a3f]/20 bg-[#eef8ef] p-4 text-sm font-bold text-[#155c2f]">
              ...
              staffUsers.map((staff) => (
                ...
                >
                  ...
                  <form action={setStaffStatusAction} className="mt-3">
                    ...
                    <button
                      type="submit"
                      disabled={staff.id === currentStaff.id && staff.status === "Active"}
                      className="rounded-full border border-[#102015]/15 px-4 py-2 text-xs font-black text-[#102015] disabled:cursor-not-allowed disabled:opacity-40"
                    >
